...
action in the CSV.
  ...
  Players to Include
    A dropdown list of all players found in your CSV (from the
    'name' column). Select one or more players to generate clips
    only for them. Leave empty to include everyone.
